              ...
              <a href="tambah_data.php" data-id_request="<?= $dt_request['id_request']; ?>" class="btn btn-sm btn-warning">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php 
                    $no =1;
                    $qr_request = mysqli_query($koneksi, "SELECT * FROM tbl_request ORDER BY tanggal_request DESC") or die (mysqli_error($koneksi));
                    ...
                    if (mysqli_num_rows($qr_request)> 0) {
                      while ($dt_request = mysqli_fetch_array($qr_request)){
                        ...
                        <tr>
                        <td><?= $no++ ; ?></td>
                        <td><?= $dt_request['tanggal_request']; ?></td>
                      ...
                      if($dt_request['status'] == '2'){
                        ...
                        ?>
                        <button type="button" class="btn btn-sm btn-primary"> Sudah delegasi</button>
                        <br> 
                      ...
                      ?>
                        ...
                        <td>
                        <button type="button" class="btn  btn-info btn-edit" data-toggle="modal" data-target="#modal-edit" data-id_request="<?= $dt_request['id_request']; ?>" data-nama_cust="<?= $dt_request['nama_cust']; ?>" data-kontak="<?= $dt_request['kontak']; ?>" data-alamat="<?= $dt_request['alamat']; ?>" data-tanggal_request="<?= $dt_request['tanggal_request']; ?>" data-keluhan="<?= $dt_request['keluhan']; ?>" data-keterangan="<?= $dt_request['keterangan']; ?>" data-id_teknisi="<?= $dt_request['id_teknisi']; ?>" data-saran_teknisi="<?= $dt_request['saran_teknisi']; ?>" data-status="<?= $dt_request['status']; ?>" ><i class="nav-icon fas fa-edit"></i></button>
                        <a href="proses.php?hps_request=<?= $dt_request['id_request']; ?>" class="btn btn-danger" onclick="return confirm('Anda akan menghapus request dengan id [<?= $dt_request['id_request'];?>]')"><i class="fas fa-trash"></i></a>
                        <br>
                     
                        <?php if ($dt_request['status'] != '3') { ?>
                        <button type="button" name="delegasi" class="btn btn-info btn-edit" data-toggle="modal" data-target="#modal-delegasi" data-id_request="<?= $dt_request['id_request']; ?>">
