...
<li class="nav-item <?php if($konstruktor=='admin_requestservice'){echo 'menu-open';} if($konstruktor=='admin_dtadmin'){echo 'menu-open';} if ($konstruktor == 'admin_teknisi'){
    echo 'menu-open'; }?>">
<a href="#" class="nav-link <?php if($konstruktor=='admin_requestservice'){echo 'active';} if($konstruktor=='admin_dtadmin'){echo 'active';} if ($konstruktor == 'admin_teknisi'){
    echo 'active'; }?>">
