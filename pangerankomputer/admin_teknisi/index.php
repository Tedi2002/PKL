                  ...
                  <tbody>
                    ...
                    if (mysqli_num_rows($sql_teknisi)> 0) {
                      while ($dt_teknisi = mysqli_fetch_array($sql_teknisi)){
                        ...
                        <td><?= $dt_teknisi['kontak']; ?></td>
                        <td><?= $dt_teknisi['alamat']; ?></td>
                        <td>
                        <a href="proses.php?hps_teknisi=<?= $dt_teknisi['id_teknisi']; ?>" class="btn btn-danger" onclick="return confirm('Anda akan menghapus teknisi dengan id [<?= $dt_teknisi['id_teknisi']; ?>] - nama : [<?= $dt_teknisi['nama']; ?>]')"><i class="fas fa-trash"></i></a>
                        </td>
